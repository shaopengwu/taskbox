...
const defaultTasks: Task[] = [
  { id: '1', title: '1 Something', state: 'TASK_INBOX' },
  { id: '2', title: '2 Something more', state: 'TASK_INBOX' },
  { id: '3', title: '3 Something else', state: 'TASK_INBOX' },
  { id: '4', title: '4 Something again', state: 'TASK_INBOX' },
];
